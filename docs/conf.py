...
latex_documents = [
    (master_doc, "dftracer.tex", "DFTracer Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "dftracer", "DFTracer Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "dftracer",
        "DFTracer is a library for wrapping function calls in shared libraries.",
        "Miscellaneous",
    ),
]
